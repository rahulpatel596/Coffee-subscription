<template>
  <div>
    <div class="w-90vw mt-8 -ml-5vw rounded-xl">
      <div
        class="w-2/3 lg:w-3/5 text-white lg:text-left md:flex ml-14 mt-16 md:mt-28 flex items-center justify-center justify-between lg:flex xl:flex 2xl:flex flex-col  absolute"
      >
        <span
